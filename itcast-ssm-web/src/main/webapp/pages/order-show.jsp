        ...
        <section class="content">
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" value="${order.orderNum}" readonly>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" id="datepicker-a3" value="${order.orderTimeStr}" readonly>
                        </div>
                    </div>

                    <div class="col-md-2 title">产品名称</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" value="${order.product.productName}" readonly>
                    </div>

                    <div class="col-md-2 title">出发城市</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" value="${order.product.cityName}" readonly>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" id="datepicker-a6" value="${order.product.departureTimeStr}" readonly>
                        </div>
                    </div>

                    <div class="col-md-2 title">出游人数</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" value="${order.peopleCount}" readonly>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <c:forEach items="${order.traveller}" var="traveller">
                        <tr>
